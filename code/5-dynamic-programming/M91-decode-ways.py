...
If the next character forms a valid single-digit value, and can thus be appended as itself to every decoding of the previous substring. 
If the next and previous character form a valid double-digit value, and can thus be appended as a pair to every decoding of the second-to-last substring. 
