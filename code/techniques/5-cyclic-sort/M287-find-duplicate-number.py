...
3. Detect Cycle:O(N) time, O(1) space (Submitted)
    ...
    - Using the Fast/Slow pointer technique, we find the point where the two pointers meet. The distance from the start to the meeting point is equal to the length of the cycle. For explanation, see https://leetcode.com/problems/linked-list-cycle-ii/
