...
1. With Sorting  
    - O((n*x)logn+ n*x) time. Sorting over x-length strings, and checking n of x-length strings for subsequences. 
...
See https://leetcode.com/problems/longest-word-in-dictionary-through-deleting/discuss/99583/Python-Simple-(Two-pointer)
'''
